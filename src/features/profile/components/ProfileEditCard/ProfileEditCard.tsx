...
export const ProfileEditCard: FC<ProfileEditCardProps> = ({ doctor, toaster, onCancel }) => {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <TimeSelector time={defaultValues?.chatSupportStartHour} onChange={(time) => setValue("chatSupportStartHour", time)} />
                                <Field.ErrorText>
                            ...
                            >
                                ...
                                <TimeSelector time={defaultValues?.chatSupportEndHour} onChange={(time) => setValue("chatSupportEndHour", time)} />
                                <Field.ErrorText>
                        ...
                        >
                            ...
                            >
                                ...
                                <TimeSelector time={defaultValues?.callSupportStartHour} onChange={(time) => setValue("callSupportStartHour", time)} />
                                <Field.ErrorText>
                            ...
                            >
                                ...
                                <TimeSelector time={defaultValues?.callSupportEndHour} onChange={(time) => setValue("callSupportEndHour", time)} />
                                <Field.ErrorText>
