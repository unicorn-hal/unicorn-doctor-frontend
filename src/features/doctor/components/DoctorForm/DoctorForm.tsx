...
export const DoctorForm: FC<DoctorFormProps> = ({
    ...
    const {
        ...
        register,
        onSelectHospital,
        onSelectDepartment } = useSaveDoctorForm(
            ...
            <form onSubmit={onSubmit}>
                ...
                >
                    <Field.Root invalid={!!errors.lastName}>
                        ...
                        <Field.Input placeholder="姓を入力してください" {...register("lastName")} />
                        <Field.ErrorText>{errors.lastName?.message}</Field.ErrorText>
                    </Field.Root>
                    <Field.Root invalid={!!errors.firstName}>
                        <Field.Label>名</Field.Label>
                        <Field.Input placeholder="名を入力してください" {...register("firstName")} />
                        <Field.ErrorText>{errors.firstName?.message}</Field.ErrorText>
                    </Field.Root>
                    <Field.Root invalid={!!errors.phoneNumber}>
                        <Field.Label>電話番号</Field.Label>
                        <Field.Input placeholder="電話番号を入力してください" {...register("phoneNumber")} />
                    ...
                    <div className={css({
                        ...
                        >
                            ...
                            <Field.ErrorText>{errors.chatSupportStartHour?.message}</Field.ErrorText>
                        </Field.Root>
                        <Field.Root
                        ...
                        >
                            ...
                            <Field.ErrorText>{errors.chatSupportEndHour?.message}</Field.ErrorText>
                        </Field.Root>
                    </div>
                    <div
                        className={css({
                    ...
                    >
                        ...
                        >
                            ...
                            <Field.ErrorText>{errors.callSupportStartHour?.message}</Field.ErrorText>
                        </Field.Root>
                        <Field.Root
                        ...
                        >
                            ...
                            <Field.ErrorText>{errors.callSupportEndHour?.message}</Field.ErrorText>
                        </Field.Root>
                    </div>
                    <DoctorImageUpload setDoctorImage={setDoctorImage} maxFileSize={MAX_FILE_SIZE} />
